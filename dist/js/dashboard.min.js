...
function dumpToCsv(){{var e=angular.element(document.querySelector("#user_table tobdy")),t=e.insertRow(e.rows.length);t.insertCell(0),document.createTextNode("New row")}}
